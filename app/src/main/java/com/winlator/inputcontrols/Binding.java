        ...
        switch (name) {
            ...
            default:
                try {
                    ...
                    // Unknown enum constant (e.g. profile saved on a newer build that
                    // added a Binding we don't know about). Fall back to NONE so the
                    // UI stays functional instead of crashing during onDraw.
                    return Binding.NONE;
                }
        }
    }
